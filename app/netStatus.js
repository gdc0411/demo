...
export default class netStatus extends Component {
    ...
    componentWillUnmount() {
        ...
        NetInfo.isConnected.removeEventListener('statusChange', this._handleNetStatusChange);
    }
    ...
    render() {
        return (
            <View >
                ...
                <Text onPress={this.goPostNet1 } style={styles.btn}>fetch-POST访问网络1/2</Text>
                <Text onPress={this.goGetNet } style={[styles.btn, { backgroundColor: 'blue' }]}>fetch-GET访问网络</Text>
            </View>
        );
    }
    ...
    goPostNet1 = () => {
        ...
        let url = 'http://uc.lecloud.com/login.do';
        let map = { method: 'POST' };
        ...
        map.body = JSON.stringify(
            {
                'username': 'raojia@le.com',
                'password': 'lecloud123456',
                'captchaCode': '6LGW',
            }
        );
        //如果服务器无法识别上面POST的数据格式，那么可以尝试传统的form格式
        //  map.body = 'username=raojia@le.com&password=lecloud123456&captchaCode=6LGW';
