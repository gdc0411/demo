...
/*播放器媒资请求回调*/
- (void)lecPlayer:(LECPlayer *) player mediaAssetsValue:(LECSaasRespModel *)respModel;
 

/*播放中暂停广告事件回调*/
- (void)lecPlayer:(LECPlayer *) player playerPauseAdState:(BOOL)isShow;
