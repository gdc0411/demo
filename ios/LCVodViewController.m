...
- (void)initVodPlayerView
{
    ...
    __weak typeof(self) wSelf = self;
        ...
        [_vodPlayer registerWithUu:self.uu vu:self.vu payCheckCode:nil payUserName:nil options:_option onlyLocalVODAvaliable:NO resumeFromLastPlayPosition:YES resumeFromLastRateType:YES completion:^(BOOL result) {
            if (result)
            {
                NSLog(@"播放器注册成功");
