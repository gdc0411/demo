...
public interface Constants {
    ...
    String EVENT_PROP_PLAY_MODE = "playMode"; //播放模式
    ...
    String EVENT_PROP_PLAY_BUFFERPERCENT = "bufferpercent"; //二级进度长度百分比
    ...
    String EVENT_PROP_VIDEO_BUFF = "videobuff";  //缓冲加载进度百分比
    ...
    String EVENT_PROP_CURRENT_LIVE = "currentLive"; //当前机位（直播）
    String EVENT_PROP_NEXT_LIVE = "nextLive"; //切换后的机位（直播）

    String EVENT_PROP_ACTIONLIVE = "actionLive"; //云直播数据
    String EVENT_PROP_LIVE_ACTION_STATE = "actionState"; //当前直播状态
    String EVENT_PROP_LIVE_COVER_IMG =  "coverImgUrl"; //封面URL（直播）
    String EVENT_PROP_LIVE_PLAYER_URL =  "playerPageUrl"; //直播页地址URL（直播）
    String EVENT_PROP_LIVE_BEGIN_TIME =  "beginTime"; //直播开始时间（直播）
    String EVENT_PROP_LIVE_START_TIME =  "startTime"; //直播开始时间（直播）

    String EVENT_PROP_LIVES = "lives";  //机位集合

    String EVENT_PROP_LIVE_ID =  "liveId"; //机位Id（直播）
    String EVENT_PROP_LIVE_MACHINE =  "machine"; //机位Id（直播）
    String EVENT_PROP_LIVE_PRV_STEAMID =  "previewSteamId"; //流ID（直播）
    String EVENT_PROP_LIVE_PRV_STEAMURL =  "previewSteamPlayUrl"; //预览流URL（直播）
    String EVENT_PROP_LIVE_STATUS =  "liveStatus"; //机位状态（直播）
