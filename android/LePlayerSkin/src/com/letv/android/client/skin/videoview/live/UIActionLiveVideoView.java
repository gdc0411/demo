...
import com.letv.android.client.sdk.api.md.entity.action.ActionInfo;
...
import com.letv.android.client.sdk.api.timeshift.ItimeShiftListener;
...
import com.letv.android.client.sdk.player.base.BaseMediaDataPlayer;
import com.letv.android.client.sdk.utils.LeLog;
...
import com.letv.android.client.skin.ui.view.V4MultLiveRightView;
import com.letv.android.client.skin.ui.view.V4MultLiveRightView.SwitchMultLiveCallback;
...
//        letvLiveUICon.setGravitySensor(false);
    ...
    protected void onInterceptLiveMediaDataSuccess(int event, Bundle bundle) {
        ...
        com.letv.android.client.sdk.api.md.entity.live.LiveInfo liveInfo = bundle.getParcelable(PlayerParams.KEY_RESULT_DATA);
        if (mV4MultLiveRightView != null) {
